...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hwinfo_scroll_area_content.setGeometry(QtCore.QRect(0, 0, 313, 328))
        ...
        self.at_bios_rb = QtWidgets.QRadioButton(self.halt_options)
        self.at_bios_rb.setObjectName("at_bios_rb")
        self.verticalLayout.addWidget(self.at_bios_rb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.at_bios_rb.setStatusTip(_translate("MainWindow", "成功安裝所有軀動後自動重新開機並進入BIOS。"))
        self.at_bios_rb.setText(_translate("MainWindow", "重啟BIOS"))
