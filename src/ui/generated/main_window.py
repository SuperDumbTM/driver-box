...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.misc_dri_scroll_area_content.setGeometry(QtCore.QRect(0, 0, 160, 101))
        ...
        self.left_vbox.addWidget(self.line_2)
        ...
        self.install_mode_options = QtWidgets.QGridLayout()
        self.install_mode_options.setContentsMargins(10, -1, 10, 0)
        self.install_mode_options.setObjectName("install_mode_options")
        self.at_install_cb = QtWidgets.QCheckBox(self.centralwidget)
        self.at_install_cb.setChecked(True)
        self.at_install_cb.setObjectName("at_install_cb")
        self.install_mode_options.addWidget(self.at_install_cb, 0, 0, 1, 1)
        self.at_retry_cb = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.install_mode_options.addWidget(self.at_retry_cb, 0, 1, 1, 1)
        self.async_install_cb = QtWidgets.QCheckBox(self.centralwidget)
        self.async_install_cb.setChecked(True)
        self.async_install_cb.setObjectName("async_install_cb")
        self.install_mode_options.addWidget(self.async_install_cb, 1, 0, 1, 1)
        self.install_option_vboc.addLayout(self.install_mode_options)
        self.halt_option_group_box = QtWidgets.QGroupBox(self.centralwidget)
        self.halt_option_group_box.setObjectName("halt_option_group_box")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.halt_option_group_box)
        self.verticalLayout.setObjectName("verticalLayout")
        self.halt_option_dropdown = QtWidgets.QComboBox(self.halt_option_group_box)
        self.halt_option_dropdown.setObjectName("halt_option_dropdown")
        self.verticalLayout.addWidget(self.halt_option_dropdown)
        self.install_option_vboc.addWidget(self.halt_option_group_box)
        ...
        self.at_init_disks_cb.setEnabled(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.halt_option_group_box.setTitle(_translate("MainWindow", "關機選項"))
        self.set_passwd_cb.setStatusTip(_translate("MainWindow", "為現時登入的帳戶更改密碼"))
        self.set_passwd_cb.setText(_translate("MainWindow", "設定密碼"))
        self.at_init_disks_cb.setText(_translate("MainWindow", "初始化所有儲存裝置"))
